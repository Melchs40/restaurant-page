...
export default function beerPage() {
    ...
    document.getElementById("main-text").appendChild(beer2);
    ...
    document.getElementById("main-text").appendChild(beer11);

    const beer12 = document.createElement("div");
    beer12.classList.add("beer-price");
    beer12.innerHTML = "----- $7 per 16oz"
    document.getElementById("main-text").appendChild(beer12);
}